...
(() => {
  ...
  const GAMES = {
    ...
    grind: { title: "The Grind", icon: "🔨", blurb: "Broke? Put in a shift: 100 clicks pays 5 ZC, sorting 75 chips pays 15. One shift of each an hour, for anyone under 50.", route: "grind" },
