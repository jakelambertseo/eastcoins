/* ============================================================
   ...
   look at where it landed. Red and black pay 1.97×, gold pays 58×.
...
(() => {
  ...
  const view = K.sharedGame({
    key: "wheel",
    title: "Wheel",
    intro: "One spin a minute. Red or black pays 1.97×; the slim gold sliver pays 58×. Forty seconds to get in.",
    running: "Spinning…",
    revealMs: 4200,
    buildStage,
    renderStage,
