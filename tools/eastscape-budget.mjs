...
const code = gz("eastscape.html") + gz("v3/assets/js/eastscape-shared.js") + gz("v3/assets/js/eastscape-sfx.js");
...
line("game windows (lazy: on the first table click, or 6 s after arriving)", kb(gz("v3/assets/js/eastscape-casino.js")), 40, "KB");
